        ...
        <>
          <Card>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              ...
              <div className="flex items-center justify-between sm:block">
                <p className="text-sm text-slate-600 dark:text-slate-300">Working Days</p>
                <p className="text-xl font-semibold text-slate-900 dark:text-slate-100">{totalWorkingDays}</p>
              </div>
              <div className="flex items-center justify-between sm:block">
